      ...
      <div className={`App${darkMode ? ' dark' : ''}`}>
        <header className={`glass-header${darkMode ? ' dark' : ''}`}>
          ...
          <div className="nav-links-container">
            ...
            <NavLink to="/" end className="nav-links desktop" onClick={() => setMenuOpen(false)}>
            ...
            <NavLink to="/projects" end className="nav-links desktop" onClick={() => setMenuOpen(false)}>
                <button className={`nav-button${darkMode ? ' dark' : ''}`}>  
              ...
              <NavLink to="/me" end className="nav-links desktop" onClick={() => setMenuOpen(false)}>
                <button className={`nav-button${darkMode ? ' dark' : ''}`}>  
...
{/* Overlay */}
        ...
        <nav className={menuOpen ? 'open' : ''}>
          ...
          <NavLink to="/" end className="nav-links celular" onClick={() => setMenuOpen(false)}>
              <button className={`nav-button${darkMode ? ' dark' : ''}`}>  
                <p className="nav-text">Home</p>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="icon-navbar">
                  <path stroke-linecap="round" stroke-linejoin="round" 
          ...
          <NavLink to="/me" end className="nav-links celular" onClick={() => setMenuOpen(false)}>
              <button className={`nav-button${darkMode ? ' dark' : ''}`}>  
                <p className="nav-text">Me</p>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="icon-navbar">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z" />
